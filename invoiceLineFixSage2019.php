<?php
	...
	//First delete all from sage2019_invoiceline_results
	$step=$database->prepare("DELETE FROM sage2019_invoiceline_result");
	$step->execute();
	...
	$step=$database->
	prepare("UPDATE sage2019_invoiceline_result SET articleCode = 'CM01020' 
	...
	$step=$database->
	prepare("UPDATE sage2019_invoiceline_result SET articleCode = 'CM01026' 
